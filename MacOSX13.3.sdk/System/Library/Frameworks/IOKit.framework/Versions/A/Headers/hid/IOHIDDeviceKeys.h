...
/**
 * @define kIOHIDDevicePrivilegedKey
 *
 * @abstract
 * Boolean property that indicates if a HID Virtual Device was created with
 * privilged entitlements for enumlating a physical device.
 */
#define kIOHIDDevicePrivilegedKey "Privileged"
